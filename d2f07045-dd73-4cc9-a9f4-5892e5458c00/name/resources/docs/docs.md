...
The rest of this page is rendered by ClojureScript found in the `src/cljs/name/core.cljs` file.
...
* Let `mount` know to start the database connection by `require`-ing `name.db.core` in some other namespace.
